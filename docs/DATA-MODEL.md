...
Selections beyond a rectangle, layer masks, linework and vector layers,
perspective rulers, and text. They belong to Stage C/D of the PRD. Adding their
fields now would be guessing at shapes we cannot test. Two cheap hooks keep them
affordable later: `LayerKind` and `format_version`.
